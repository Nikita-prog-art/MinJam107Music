...
s_crt = (
	pygame.mixer.Sound("res/move.wav"),
	pygame.mixer.Sound("res/bad_move.wav")
)
...
h_players = [entity.Box_entity("player.png"), entity.Box_entity("player.png"), entity.Box_entity("player.png")]
...
CREATE_NOTE = pygame.USEREVENT
pygame.time.set_timer(CREATE_NOTE, 1000)
